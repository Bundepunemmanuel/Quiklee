...
function buildClassifyPrompt(seedTopic, existingFormulas, keywords) {
  return `You are sorting search keywords for a calculator website into exactly 3 categories.
...
2. Label "existing-formula-new-page" if the keyword uses one of the existing formulas above
   ...
   high school" using the same math).
3. Label "fold-into-faq" for everything else — a real question, but answerable as FAQ content
   on an existing page rather than needing a new page or new formula.
...
Output ONLY valid JSON, no markdown fences, no commentary:
{
  ...
  "existing-formula-new-page": [{"keyword":"...","suggestedPage":"short page name"}],
